...
#set yrange [1:]
plot 'benchmark-results.data' using 1:4:5 with errorbars title 'Direct' lt rgb '#DC143C', \
     'benchmark-results.data' using 1:8:9 with errorbars title 'Volatile' lt rgb '#A52A2A', \
     'benchmark-results.data' using 1:12:13 with errorbars title 'Synchronized' lt rgb '#00CC00', \
